 ...
 */
public class desc4 extends Fragment {


    public EditText plastik1,kaleng1,kertas1;
    ...
    private void total1(int kaleng1,int kertas1,int plastik1){
        double hasilvolume=(kertas1*1000)+(kaleng1*2500)+(plastik1*1000);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        kaleng1 = view.findViewById(R.id.kaleng1);
        kertas1 = view.findViewById(R.id.kertas1);
        plastik1 = view.findViewById(R.id.plastik1);
        ...
        kalkulasi1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                String plastik= plastik1.getText().toString();
                String kaleng = kaleng1.getText().toString();
                String kertas = kertas1.getText().toString();
